        ...
        >
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/estimation/"
                className="group flex items-center gap-2 px-8 py-4 border border-blue-400/70 rounded-full text-blue-100 font-semibold bg-slate-900/40 hover:bg-slate-900/70 transition-all"
              >
