    ...
    <section className="hero site-container" aria-labelledby="hero-title">
      ...
      <div className="hero-showcase">
        ...
        <div className="hero-screens">
          ...
          <a className="hero-screen hero-screen-right" href="#app-3" aria-label="Découvrir Do it fast!"><Image src="/screenshots/doitfast1.png" width={1284} height={2778} sizes="(max-width: 600px) 34vw, 210px" priority alt="Do it fast! : un jeu de mots à partager en équipe" /></a>
