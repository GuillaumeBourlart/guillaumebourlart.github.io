...
export default function Footer() {
  return (
    <footer className="site-footer site-container">
      ...
      <div className="footer-bottom"><p>© {new Date().getFullYear()} Mobiverse Games</p><nav aria-label="Informations"><Link href="/a-propos/">À propos</Link><Link href="/pawder/assistance/">Assistance Pawder</Link><a href="mailto:contact.gb.entreprise@gmail.com">Contact</a></nav><a href="#main-content">Retour en haut ↑</a></div>
    </footer>
  )
}
